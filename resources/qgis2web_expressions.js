...
function exp_label_BuenosAiresPalmPlantations_Contour_5_eval_expression(context) {
    // ELEV || ' m'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ELEV')  + ' m');
    } else {
        return (feature.get('ELEV')  + ' m');
    }
}
...
function exp_label_Block_Boundaries_6_eval_expression(context) {
    // "Block Name" || '\n' || 'Area= ' || (Area / 10000) || ' ha'

    var feature = context.feature;
    
    if (feature.properties) {
        return ((((feature.get('Block Name')  + '\n') + 'Area= ') + (feature.get('Area')  / 10000)) + ' ha');
    } else {
        return ((((feature.get('Block Name')  + '\n') + 'Area= ') + (feature.get('Area')  / 10000)) + ' ha');
    }
}